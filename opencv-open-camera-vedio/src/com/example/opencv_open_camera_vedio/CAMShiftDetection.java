...
public class CAMShiftDetection {
	...
	public Mat getImageHistogram(Mat huesImage, Size size, int buckets,
	...
	public Mat getBackProjection(Mat in, Mat histogram, int minRange,
